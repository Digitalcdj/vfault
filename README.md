...
- [ ] CI/CD GitHub Action
- [x] Hosted API service — exceedweb.pythonanywhere.com
...
VFault uses a three-agent streaming pipeline. For the full specification including the verified/contested knowledge distinction, competitive analysis, economic model, and deployment roadmap, see `docs/architecture.md`.
